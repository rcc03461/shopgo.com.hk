...
**Goal:** 为 `http://demo.oshop.com.hk:3000/` 的首页落地三个可维护区块：Hero、Slider、Categories Products，并保持现有多租户分支逻辑不回归。
...
Run: `bun dev`  
Expected: PASS，打开 `http://demo.oshop.com.hk:3000/` 可看到 Hero 区块与双 CTA。
