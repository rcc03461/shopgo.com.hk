...
- `shop_slug.oshop.com.hk/payment`
  - 付款頁
- `shop_slug.oshop.com.hk/payment/complete`
  - 訂單完成頁（付款成功後）
- `shop_slug.oshop.com.hk/orders/order_uuid`
  - 訂單明細頁（規劃中）
...
- `shop_slug.oshop.com.hk/profile`
  - 會員資料頁
- `shop_slug.oshop.com.hk/profile/orders`
  - 會員訂單列表
- `shop_slug.oshop.com.hk/profile/orders/order_uuid`
  - 會員訂單詳情
